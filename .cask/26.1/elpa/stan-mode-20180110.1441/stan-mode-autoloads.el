...

;;;### (autoloads nil "stan-keywords-lists" "stan-keywords-lists.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from stan-keywords-lists.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "stan-keywords-lists" '("stan-")))
